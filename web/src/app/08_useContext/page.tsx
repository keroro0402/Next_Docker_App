import UseContext03 from '@/app/08_useContext/components/useContext03';
import UseContext02 from '@/app/08_useContext/components/useContext02';
...
export default function UseContext() {
  return (
    <>
      ...
      <div className='card'>{<UseContext03 />}</div>
      <div className='card'>{<UseContext02 />}</div>
